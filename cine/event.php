...
?>
    ...
    <section class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/bg-img/breadcumb3.jpg);">
      <div class="bradcumbContent">
        ...
        <p></p>
        <a href="event2.php?note=1">Clique ici pour afficher<br>uniquement ceux avec note</a>
      </div>
    </section>
    <!-- ##### Breadcumb Area End ##### -->
    <!-- ##### Events Area Start ##### -->
    <section class="events-area section-padding-100">
      <div class="container">
        <div class="row">
          <!-- Single Event Area -->
          <?php
if($db_found && (isset($_GET['q']) == false) && (isset($_GET['note']) == false))
{
...
else if($db_found && (isset($_GET['q'])) && (isset($_GET['note']) == false))
{
  $search = $_GET['q'];
  $result = 0;
