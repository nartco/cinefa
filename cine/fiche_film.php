...
<?php
        ...
        if($db_found && isset($_GET['id'])){
            ...
            $sql_query3 = 'SELECT AVG(note) FROM MOVIES INNER JOIN MOVIE_NOTES ON MOVIES.id_movie = MOVIE_NOTES.id_movie';
            $result_query3 = mysqli_query($db_handle, $sql_query3);
            
            $db_field3 = mysqli_fetch_assoc($result_query3);
            $moyenne = intval($db_field3['AVG(note)']);
                    ...
                    <div class="contact-content mb-100">
                        ...
                        <div class="single-contact-info d-flex align-items-center">
                            ...
                            <div class="rating">
                               ...
                               <a href="rating.php?rating='2'&movie=<?php echo $id1 ?>"><span>☆</span></a>
                               <a href="rating.php?rating='3'&movie=<?php echo $id1 ?>"><span>☆</span></a>
                               <a href="rating.php?rating='4'&movie=<?php echo $id1 ?>"><span>☆</span></a>
                               <a href="rating.php?rating='5'&movie=<?php echo $id1 ?>"><span>☆</span></a>
